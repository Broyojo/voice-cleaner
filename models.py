...
class ConvolutionalAutoEncoder:
    def __init__(self, input_dim, compression_size, save_path):
        ...
        encoder_input = keras.Input(shape=(input_dim, 1), name="original_image")
        ...
        self.autoencoder.compile(
            optimizer=keras.optimizers.Adam(epsilon=1e-06),
            loss="mse",
            metrics=["accuracy"],
        )  # Adjust loss
...
class LinearAutoEncoder:
    def __init__(self, input_dim, latent_dim, save_path):
        ...
        self.model = keras.Model(inputs=inputs, outputs=outputs, name="autoencoder")
        self.model.summary()
